set(DIGITOR_APPLE_FLUTTER_BRIDGE_SOURCE "" CACHE FILEPATH
    "Flutter macOS/iOS plugin source implementing AppleFlutterTextureBridge")
...
function(digitor_configure_apple_native_provider target)
  ...
  if(NOT DIGITOR_APPLE_FLUTTER_BRIDGE_SOURCE OR
    ...
    message(FATAL_ERROR
      "DIGITOR_APPLE_FLUTTER_BRIDGE_SOURCE must name a real Flutter Apple plugin source")
  endif()
  ...
  message(STATUS "DigitorEngine Apple native provider: ${DIGITOR_APPLE_PROVIDER_IDENTITY}")
endfunction()
