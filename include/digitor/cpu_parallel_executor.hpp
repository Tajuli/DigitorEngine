...
// Persistent deterministic scheduler shared by CPU render, image, video and
// effect paths. Fixed contiguous ranges give every output element one owner, so
// worker scheduling cannot change per-pixel results.
