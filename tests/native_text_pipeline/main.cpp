...
int main(){
  ...
  ShapingRequest bn;bn.utf8=u8"বাংলা লেখা";bn.primary_font={"Noto Sans Bengali","fixture.ttf",0,400,false};bn.font_size=32;
  ...
  ShapingRequest ar;ar.utf8=u8"العربية";ar.primary_font=bn.primary_font;const auto rtl=pipeline.shape(ar);if(rtl.direction!=TextDirection::right_to_left)return 5;
