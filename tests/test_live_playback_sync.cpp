...
int main() {
  ...
  const std::vector<digitor::PlaybackFrameTiming> frames{
      {0, 33333}, {33333, 33333}, {66666, 33333}};
  ...
  const bool probe_available = sync.refresh_probe(1000000);
  (void)probe_available;
