...
struct ExecutionProvenance {
  ...
  std::string log_wheels_parameter_identity;
  std::string log_wheels_shader_identity;
  std::string log_wheels_pipeline_identity;
  bool log_wheels_parameters_bound{};
  bool log_wheels_source_bound{};
  bool log_wheels_destination_bound{};
  std::uint64_t cpu_log_wheels_invocations{};
  std::uint64_t log_wheels_fallback_invocations{};
  bool hsl_qualifier_enabled{};
  std::string hsl_qualifier_parameter_identity;
  std::string hsl_qualifier_shader_identity;
  std::string hsl_qualifier_pipeline_identity;
  bool hsl_qualifier_parameters_bound{};
  bool hsl_qualifier_source_bound{};
  bool hsl_qualifier_destination_bound{};
