...
## RGB Curves shader status

No RGB Curves shader ABI is qualified in v1 of the parameter contract. SPIR-V, DXIL, Metal, and GLSL ES curve modules and reflection layouts remain unsupported; shader compilation success must not be represented as curve execution evidence.
